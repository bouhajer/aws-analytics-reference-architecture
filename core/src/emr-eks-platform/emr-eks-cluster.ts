...
export class EmrEksCluster extends Construct {
  ...
  private constructor(scope: Construct, id: string, props: EmrEksClusterProps) {
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      Stack.of(this),
      'eks-emr-studio/data-platformCluster/DefaultVpc/Resource',
      [{ id: 'AwsSolutions-VPC7', reason: 'Flowlog is not created at VPC creation, it is created independently' }],
    );


    this.eksVpc?.addFlowLog('eksVpcFlowLog', {
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      ...
      [{ id: 'AwsSolutions-S1', reason: 'Bucket used only to store EKS assets like podTemplates, no need to activate access logs' }],
    );
...
`);
  ...
  public uploadPodTemplate(id: string, filePath: string) {
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      Stack.of(this),
      'eks-emr-studio/Custom::CDKBucketDeployment8693BB64968944B69AAFB0CC9EB8756C/ServiceRole/Resource',
      [{ id: 'AwsSolutions-IAM4', reason: 'IAM policy generated by AWS provided construct' }],
    );

    NagSuppressions.addResourceSuppressionsByPath(
      Stack.of(this),
      'eks-emr-studio/Custom::CDKBucketDeployment8693BB64968944B69AAFB0CC9EB8756C/ServiceRole/DefaultPolicy/Resource',
      [{ id: 'AwsSolutions-IAM5', reason: 'IAM policy generated by AWS provided construct' }],
    );
  }
